...
{
    .mapDataPressed = kbdGfxNumericMap + ROWS_OF_KEYS * KEYS_IN_ROW * 2,
    .mapDataReleased = kbdGfxNumericMap,
    .keymap = KbdUpper,
    .width = ROWS_OF_KEYS,
    .height = KEYS_IN_ROW
};
...
{
    .mapDataPressed = kbdGfxNumericMap + ROWS_OF_KEYS * KEYS_IN_ROW * 3,
    .mapDataReleased = kbdGfxNumericMap + ROWS_OF_KEYS * KEYS_IN_ROW,
    .keymap = KbdLower,
    .width = ROWS_OF_KEYS,
    .height = KEYS_IN_ROW
};

const Keyboard kbdNumeric =
{
    .scrollSpeed = 6,
    ...
    .tiles = kbdGfxNumericTiles,       // graphics tiles
    .tileLen = kbdGfxNumericTilesLen,  // graphics tiles length
    .palette = kbdGfxNumericPal,       // palette
    .paletteLen = kbdGfxNumericPalLen, // size of palette
